...
var SERVICES = [
  {
    ...
    price: 'от 8 000 руб', includes: ['Монтаж блоков', 'Прокладка трассы', 'Вакуумирование', 'Пуско-наладка', 'Гарантия 2 года']
  },
  {
    ...
    price: 'от 25 000 руб', includes: ['Проектирование', 'Монтаж блоков', 'Воздуховоды', 'Настройка', 'Гарантия 2 года']
  },
  {
    ...
    price: 'от 3 500 руб', includes: ['Чистка фильтров', 'Мойка блоков', 'Проверка давления', 'Диагностика', 'Акт выполнения']
  },
  {
    ...
    price: 'от 2 000 руб', includes: ['Проверка утечек', 'Вакуумирование', 'Заправка фреоном', 'Проверка давления', 'Контроль работы']
  },
  {
    ...
    price: 'от 15 000 руб', includes: ['Обследование объекта', 'Расчёт нагрузок', 'Выбор оборудования', 'Проектная документация', 'Согласование']
  },
  {
    ...
    price: 'от 1 500 руб', includes: ['Выезд мастера', 'Диагностика', 'Ремонт', 'Замена деталей', 'Гарантия на ремонт']
  }
];
